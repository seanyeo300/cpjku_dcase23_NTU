...
from datasets.dcase24_ntu_teacher_SKD4 import ntu_get_training_set_dir, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5
...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--project_name', type=str, default="NTU24_ASC_SKD")
    parser.add_argument('--experiment_name', type=str, default="NTU_SKD4_gen1_scdhurtv_T_6wh275ty_S_h5") # This script is meant for pre-trained students
    parser.add_argument('--num_workers', type=int, default=0)  # number of workers for dataloaders
    parser.add_argument('--precision', type=str, default="32")
    
    # evaluation
    parser.add_argument('--evaluate', action='store_true')  # predictions on eval set
    parser.add_argument('--ckpt_id', type=str, default="6wh275ty")  # for loading trained model, corresponds to wandb id
