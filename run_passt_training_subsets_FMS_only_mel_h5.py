...
def train(config):
    ...
    hf_in = open_h5('h5py_TAU22_128bins')
    # hmic_in = open_h5('h5py_mic_wav_1')

    # get_training set already as logic to handle dir_prob=0
    train_dl = DataLoader(dataset=ntu_get_training_set_dir(config.subset, config.dir_prob, hf_in, hmic_in=None),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="CPJKU_passt_teacher_training_sub5_441K_FMS_only_h5")
