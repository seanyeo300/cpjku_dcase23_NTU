...
from datasets.cochl_ntu_teacher import ntu_get_training_set_dir, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="CPJKU_passt_teacher_training_cochl_441K_FMS_mel_h5")
