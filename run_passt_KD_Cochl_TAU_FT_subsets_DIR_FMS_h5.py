...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="NTU_KD_Seq-FT-SL-10_T_doubleSL_Seq-FT-SL-10_S_FMS_DIR_h5") # This script is meant for pre-trained students
