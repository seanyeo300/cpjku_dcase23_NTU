...
from datasets.ICME_ntu_teacher_mel import ntu_get_test_subset_cochl, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5,ntu_ICME_subset_dir, ntu_cochl_val_set
...
class PLModule(pl.LightningModule):
    def __init__(self, config):
        ...
        # self.label_ids = ['beach', 'bus', 'cafe/restaurant','car','city_center',
                        #   'forest_path','grocery_store','home','library','metro_station',
                        #   'office','park','residential_area','train','tram']
        self.label_ids = ['Airport', 'Urban park', 'Traffic street', 'Public square', 'Restaurant',
                          'Bus', 'Shopping mall' ,'Metro', 'Bar', 'Construction site']
...
def train(config):
    ...
    hf_in = open_h5('h5py_ICME_128_1s_mel')
    ...
    train_dl = DataLoader(dataset=ntu_ICME_subset_dir(config.subset, config.dir_prob, hf_in, hmic_in),
...
def evaluate(config):
    ...
    ############# h5 edit here ##############
    # Open h5 file once
    hf_in = open_h5('h5py_TUT_2018_128_mel')
...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--project_name', type=str, default="NTU25_ICME_SL")
    parser.add_argument('--experiment_name', type=str, default="NTU_PaSST_ICME_slow_fast_FGlr_8e-6_h5")
    ...
    parser.add_argument('--subset', default="ICME") # cochlsub10, "cochlOLsub10", cochlNoOLsub10
    # model
