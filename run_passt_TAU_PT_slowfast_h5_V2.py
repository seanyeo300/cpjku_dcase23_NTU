...
from datasets.dcase24_ntu_teacher_v5 import ntu_get_training_set_dir, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5, ntu_get_sub_training_set_dir, ntu_get_test_sub_set
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="CPJKU_passt_TAU5Esub5_slow_fast_FGlr_1e-4_h5") # Changed helper file, subset, number of classes and label ids?
    ...
    parser.add_argument('--subset', type=str,default="5sub5E") # cochlsub10, "cochlOLsub10", cochlNoOLsub10
    # model
