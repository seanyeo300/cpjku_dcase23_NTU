...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="CPJKU_passt_teacher_training_sub5_441K_FMS")
    ...
    parser.add_argument('--dir_prob', type=float, default=0)  # prob of applying device impulse response augmentation # need to specify
