...
dataset_dir = r"D:\Sean\TUT17" # Alibaba
...
dataset_config = {
    ...
    "split_path": "split_setup/TUT17",
    "split_url": "https://github.com/CPJKU/dcase2024_task1_baseline/releases/download/files/",
    "test_split_csv": "test_TUT.csv",
    "cochl_test_split_csv": "test_TUT.csv",
...
def ntu_TUT_subset_dir(split=None, dir_prob = False, hf_in=None, hmic_in=None): # this variant is for DIR augmentation
    assert str(split) in ("TUT"), "Parameters 'split' must be in [5, 10, 25, 50, 100]"
    os.makedirs(dataset_config['split_path'], exist_ok=True)
    subset_fname = f"split{split}.csv"
    subset_split_file = os.path.join(dataset_config['split_path'], subset_fname)
