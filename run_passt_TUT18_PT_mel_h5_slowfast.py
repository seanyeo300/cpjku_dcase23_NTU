...
from datasets.TUT18_ntu_teacher_mel import ntu_get_test_subset_cochl, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5,ntu_TUT_subset_dir, ntu_cochl_val_set
...
def train(config):
    ...
    train_dl = DataLoader(dataset=ntu_TUT_subset_dir(config.subset, config.dir_prob, hf_in, hmic_in),
...
if __name__ == '__main__':
    ...
    # general
    parser.add_argument('--project_name', type=str, default="NTU25_TUT18_SL")
    parser.add_argument('--experiment_name', type=str, default="NTU_PaSST_TUT18_slow_fast_FGlr_1e-4_h5")
    ...
    parser.add_argument('--subset', default="TUT") # cochlsub10, "cochlOLsub10", cochlNoOLsub10
    # model
