...
from datasets.dcase24_ntu_teacher_tv2 import ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5
...
class PLModule(pl.LightningModule):
    ...
    def test_step(self, test_batch, batch_idx):
        ...
        # Store normalized embeddings and labels for later saving
    ...
    def on_test_epoch_end(self):
        ...
        # Save normalized embeddings and labels to text files
