...
if __name__ == "__main__":
    ...
    script_name = 'run_SSAST_training_subsets_DIR_FMS_h5.py'
    
    # Base arguments (common to all runs, except experiment name and ckpt_id)
    base_args = ["--subset", "25", "--gpu", "[0]" ,"--n_epochs", "20" ,"--dir_prob", "0.6", "--mixstyle_p", "0.4", "--weight_decay", "0.001", "--lr", "8e-5", "--resample_rate", "44100"]
    ...
    ckpt_experiment_pairs = [
        ...
        (None, "NTU_SSAST_FTtau_441K_FMS_DIR_8e-5_avgcls_h5")          #Ptau
    ]
