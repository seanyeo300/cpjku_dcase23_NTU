...
if __name__ == "__main__":
    ...
    base_args = ["--subset", "5", "--n_epochs", "12" ,"--dir_prob", "0.6", "--mixstyle_p", "0.4", "--weight_decay", "0.001", "--lr", "1e-4", "--resample_rate", "44100"]
    ...
    ckpt_experiment_pairs = [
        ...
        (None, "NTU_PANNs_FTtau_441K_FMS_DIR_1e-4_adamw_WD0.001_h5")          #Ptau
    ]
