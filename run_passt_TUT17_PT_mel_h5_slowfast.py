...
from datasets.TUT17_ntu_teacher_mel import ntu_get_test_subset_cochl, ntu_get_test_set, ntu_get_eval_set, open_h5, close_h5,ntu_TUT_subset_dir, ntu_cochl_val_set
...
def train(config):
    ...
    hf_in = open_h5('h5py_TUT_2017_128_mel')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="NTU_PaSST_TUT_slow_fast_FGlr_1e-4_h5")
